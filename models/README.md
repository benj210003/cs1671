...
| $\color{blue}{\textsf{Taigi-Llama-2-Translator-7B + CM datasets}}$ | Fine-tuning Taigi-Llama-2-Translator-7B with parallel code-mixed data in Taiwanese Hokkien (matrix) and Mandarin Chinese (embedding). | 🆕 Our Model | |
| $\color{blue}{\textsf{Taigi-Llama-2-Translator-13B + CM datasets}}$ | Fine-tuning Taigi-Llama-2-Translator-13B with parallel code-mixed data in Taiwanese Hokkien (matrix) and Mandarin Chinese (embedding). | 🆕 Our Model | |
